...
import com.amos.koperasi.Adapter.MenyerahkanAdapter;
 ...
 */
public class MenyerahkanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_menyerahkan, container, false);
        ...
        url = sharedPreferenceConfig.getUrl()+"listdisetujui.php";
        recyclerView = view.findViewById(R.id.rvcontainer);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        MenyerahkanAdapter notifikasiAdminAdapter = new MenyerahkanAdapter(list,getActivity());
